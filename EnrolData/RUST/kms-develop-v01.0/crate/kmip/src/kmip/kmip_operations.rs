...
/* Note: The response for the create request in ttlv format
{
  "tag": "CreateResponse",
  "type": "Structure",
  "value": [
    ...
    },
    {
      ...
      "type": "TextString",
      "value": "6927b9ce-5010-496b-802a-86f7b0adce6e"
    }
  ]
}
*/
...
/*Note: The Get struct defines a request for the Key Management Interoperability Protocol (KMIP) that allows a client to request a managed object (like a cryptographic key or certificate) from the KMS based on its unique identifier. This operation is essential for retrieving stored cryptographic material from the KMS.*/
...
/*Note: This implementation provides a formatted string representation of a Get instance, useful for logging and debugging. */
...
impl Get {
    ...
    /// ```
    #[must_use]
    /*Note: This method constructs a Get request. It sets the appropriate key_wrap_type based on whether the object should be unwrapped. It ensures that the required fields are populated correctly. */
    pub const fn new(
...
/*Note: Various From implementations are provided to allow easy creation of a Get request from different input types, including UniqueIdentifier, String, and &str. This enhances the usability of the Get struct by allowing it to be instantiated from various types. */
...
/*Note: The response from the Get request is encapsulated in the GetResponse struct: */
#[derive(Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "PascalCase")]
...
/*Note: Similar to the Get struct, this provides a formatted string representation for logging and debugging purposes. */
...
/*Note: This implementation allows a GetResponse to be constructed directly from an ExportResponse, facilitating the handling of responses from different operations. */
